...
public class custom_view_order extends BaseAdapter {
    ...
    public custom_view_order(Context applicationContext, String[] order_id, String[] amount, String[] date, String[] status, String[] delivery_status, String[] payment_status, String[] payment_date, String[] restaurant_info) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            gridView = inflator.inflate(R.layout.activity_custom_view_order, null);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ed.commit();
                Intent i = new Intent(context.getApplicationContext(),send_rating_and_comment.class);
