...
public class view_nearest_restaurant extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_nearest_restaurant);
        li = findViewById(R.id.listview);

        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ipaddress","");
        String url = sh.getString("url","") + "and_view_nearby_restaurant";
...
//                                }
                                ...
                                li.setAdapter(new custom_view_nearest_restaurant(getApplicationContext(),rid,name,email,contact,latitude,longitude));
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("lati",sh.getString("lati",""));
                params.put("longi",sh.getString("longi",""));
