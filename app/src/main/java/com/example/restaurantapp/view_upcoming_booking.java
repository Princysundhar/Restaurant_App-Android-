...
public class view_upcoming_booking extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_upcoming_booking);

        li = findViewById(R.id.listview);

        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ipaddress","");
        String url = sh.getString("url","") + "and_view_upcoming_booking";
...
//                                }
                                ...
                                li.setAdapter(new custom_view_upcoming_booking(getApplicationContext(),order_id,amount,date,status,delivery_status,payment_status,payment_date,restaurant_info));
