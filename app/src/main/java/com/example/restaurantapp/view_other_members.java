...
public class view_other_members extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_other_members);
        li = findViewById(R.id.listview);

        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ipaddress","");
        String url = sh.getString("url","") + "and_view_other_member";
...
//                                }
                                ...
                                li.setAdapter(new custom_view_other_members(getApplicationContext(),member_id,name,contact));
