...
public class custom_view_prebooking extends BaseAdapter {
    String[]order_id,amount,date,status,delivery_status,payment_status,payment_date,restaurant_info;
    private Context context;

    public custom_view_prebooking(Context applicationContext, String[] order_id, String[] amount, String[] date, String[] status, String[] delivery_status, String[] payment_status, String[] payment_date, String[] restaurant_info) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            gridView = inflator.inflate(R.layout.activity_custom_view_prebooking, null);
...
//        Button b2 = (Button) gridView.findViewById(R.id.button15);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ed.commit();
                Intent i = new Intent(context.getApplicationContext(),payment_mode.class);
