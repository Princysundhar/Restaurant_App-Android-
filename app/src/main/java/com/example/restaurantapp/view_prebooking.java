...
public class view_prebooking extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_prebooking);

        li = findViewById(R.id.listview);

        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ipaddress","");
        String url = sh.getString("url","") + "and_view_prebooking";
...
//                                }
                                ...
                                li.setAdapter(new custom_view_prebooking(getApplicationContext(),order_id,amount,date,status,delivery_status,payment_status,payment_date,restaurant_info));
